package casestudybookingcusdate;
...
public class CaseStudyMain 
{
	public static void main(String[] args)
	{
		...
		CaseStudyBooking arr[]=new CaseStudyBooking[10];
		CaseStudyView brr[]=new CaseStudyView[10];
